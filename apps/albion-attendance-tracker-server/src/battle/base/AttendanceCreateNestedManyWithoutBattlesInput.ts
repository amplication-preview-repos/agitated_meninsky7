...
@InputType()
class AttendanceCreateNestedManyWithoutBattlesInput {
...
export { AttendanceCreateNestedManyWithoutBattlesInput as AttendanceCreateNestedManyWithoutBattlesInput };
